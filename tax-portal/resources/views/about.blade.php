...
<section class="hero-section text-center">
    <div class="container">
        <h1 class="hero-title">About CONSULT</h1>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-6">
                ...
                <p>CONSULT provides expert solutions for tax compliance, financial management, and business growth strategies. Our team helps clients achieve success efficiently and professionally.</p>
